...
Ext.onReady(function(){
    ...
    var store = new Ext.data.JsonStore({
        ...
        data: [
            {name:'Jul 07', visits: 24, views: 30},
            {name:'Aug 07', visits: 24, views: 35},
            {name:'Sep 07', visits: 35, views: 40},
            {name:'Oct 07', visits: 37, views: 42},
            {name:'Nov 07', visits: 49, views: 45},
            {name:'Dec 07', visits: 49, views: 58},
            {name:'Jan 08', visits: 52, views: 60},
            {name:'Feb 08', visits: 62, views: 75}
        ]
    });
